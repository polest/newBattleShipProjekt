...
public class InitGame_View {
	...
	public int getCellSize(){
		return this.battleFieldView.getCellSize();
	}
	...
	public void setDestroyerIcon(int mouseX, int mouseY, char orientation){
		this.battleFieldView.setDestroyerIcon(mouseX, mouseY, orientation);
	}
	
	public void setDestroyerIconVisible(boolean state){
		this.battleFieldView.setDestroyerIconVisible(state);
		this.initGamePan.repaint();
	}
